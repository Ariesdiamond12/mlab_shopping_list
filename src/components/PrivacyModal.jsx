          ...
          {(onClose) => (
            <>
              ...
              <ModalBody>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Shopping
                      List.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Shopping List,
                      accessible from{" "}
                      <a
                        href="http://localhost:5174/shopping-list"
                        rel="external nofollow noopener"
                        target="_blank"
                      >
                        http://localhost:5174/shopping-list
                      </a>
                    </p>
                  </li>
                  <li>
                ...
                <h3><strong>Delete Your Personal Data</strong></h3>
                <p>
